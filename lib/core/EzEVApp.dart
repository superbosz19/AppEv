    ...
    return GetMaterialApp(
      //  initialBinding: AuthBinding(),
        ...
        getPages: [
          ...
          GetPage(name: "/change-avatar", page:()=> ChangeAvatarPage(),),
          GetPage(name: "/idcard-page", page:()=> IDCardPage(),),
          GetPage(name: "/select-payment", page:()=> SelectPaymentPage(),),
          GetPage(name: "/charging-page", page:()=>ChargingPage(),),
          GetPage(name: "/charge-result", page:()=>ChargeResultPage(),),
          GetPage(name: "/payment-config", page:()=>PaymentConfigPage(),),
          GetPage(name: "/addpayment-page", page:()=>AddPaymentPage(),),
          GetPage(name: "/confirm-payment", page:()=> ConfirmPaymentPage(),),
          GetPage(name: "/linepay", page:()=> LinePayPage(),),
...
class _EzEVAppState  {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        Provider<CustomTheme>( create : (_) => theme,),
